## combat_act1_corp_elite.rpy — Narrative combat: Corporate Elite Squad
## Enemies: 1x Corporate Commander, 1x Corporate Heavy, 2x Corporate Trooper
## Auto-generated skeleton — add flavor text

label combat_act1_corp_elite:
    $ _nc = NarrativeCombat("act1_corp_elite")
    show screen combat_hud(_nc)

    "Elite corporate configuration - commander coordinating a heavy and two troopers. Rally buffs, armor, suppression, and discipline. Very dangerous."
...
label .combat_end:
    ...
    if _nc.victory:
        $ game_state.mark_encounter_cleared("act1_corp_elite")
        $ party_manager.award_xp(200)
        $ game_state.set_flag("elite_squad_defeated")
        ...
        $ game_state.set_flag("act1_corp_elite_lost")
