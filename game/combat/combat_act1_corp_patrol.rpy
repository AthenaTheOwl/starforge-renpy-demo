## combat_act1_corp_patrol.rpy — Narrative combat: Corporate Patrol
## Enemies: 1x Corporate Commander, 2x Corporate Trooper
## Auto-generated skeleton — add flavor text

label combat_act1_corp_patrol:
    $ _nc = NarrativeCombat("act1_corp_patrol")
    show screen combat_hud(_nc)

    "A commander leads a standard two-trooper patrol. Organized and disciplined - the commander's Rally ability makes the entire squad more dangerous."
...
label .combat_end:
    ...
    if _nc.victory:
        $ game_state.mark_encounter_cleared("act1_corp_patrol")
        $ party_manager.award_xp(150)
        $ game_state.set_flag("corp_patrol_defeated")
        ...
        $ game_state.set_flag("act1_corp_patrol_lost")
