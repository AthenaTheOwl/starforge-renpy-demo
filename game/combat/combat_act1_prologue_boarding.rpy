## combat_act1_prologue_boarding.rpy — Narrative combat: Boarding Action — Prologue
## Enemies: 4x Raider, 1x Raider Demolitionist
## Auto-generated skeleton — add flavor text

label combat_act1_prologue_boarding:
    $ _nc = NarrativeCombat("act1_prologue_boarding")
    show screen combat_hud(_nc)

    "Unregistered raiders breach the Lumen Thief's starboard cargo bay. Mismatched armor, rusty coordination, desperation debt on their wrists. Four mobile hostiles plus one demolitions specialist."
...
label .combat_end:
    ...
    if _nc.victory:
        $ game_state.mark_encounter_cleared("act1_prologue_boarding")
        $ party_manager.award_xp(75)
        $ game_state.set_flag("prologue_boarding_complete")
        ...
        $ game_state.set_flag("act1_prologue_boarding_lost")
