## combat_act1_cult_ritual.rpy — Narrative combat: Cult Ritual Interrupted
## Enemies: 2x Cult Acolyte, 1x Cult Binder
## Auto-generated skeleton — add flavor text

label combat_act1_cult_ritual:
    $ _nc = NarrativeCombat("act1_cult_ritual")
    show screen combat_hud(_nc)

    "Ward cultists performing a resonance ritual. Two acolytes provide healing and offense while a binder locks down targets with immobilization wards."
...
label .combat_end:
    ...
    if _nc.victory:
        $ game_state.mark_encounter_cleared("act1_cult_ritual")
        $ party_manager.award_xp(150)
        $ game_state.set_flag("cult_ritual_disrupted")
        ...
        $ game_state.set_flag("act1_cult_ritual_lost")
