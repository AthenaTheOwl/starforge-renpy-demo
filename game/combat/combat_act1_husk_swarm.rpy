## combat_act1_husk_swarm.rpy — Narrative combat: Husk Swarm
## Enemies: 4x Lattice Shard
## Auto-generated skeleton — add flavor text

label combat_act1_husk_swarm:
    $ _nc = NarrativeCombat("act1_husk_swarm")
    show screen combat_hud(_nc)

    "Lattice shards respond to resonance signatures. Four crystalline entities converge - individually weak but dangerous in numbers."
...
label .combat_end:
    ...
    if _nc.victory:
        $ game_state.mark_encounter_cleared("act1_husk_swarm")
        $ party_manager.award_xp(200)
        $ game_state.set_flag("husk_swarm_defeated")
        ...
        $ game_state.set_flag("act1_husk_swarm_lost")
