## combat_act1_husk_echo.rpy — Narrative combat: Husk Echo Manifestation
## Enemies: 1x Lattice Echo, 2x Lattice Shard
## Auto-generated skeleton — add flavor text

label combat_act1_husk_echo:
    $ _nc = NarrativeCombat("act1_husk_echo")
    show screen combat_hud(_nc)

    "A Lattice Echo supported by shard swarmers. The echo mirrors your abilities at reduced power - unpredictable and disorienting."
...
label .combat_end:
    ...
    if _nc.victory:
        $ game_state.mark_encounter_cleared("act1_husk_echo")
        $ party_manager.award_xp(150)
        $ game_state.set_flag("echo_defeated")
        ...
        $ game_state.set_flag("act1_husk_echo_lost")
