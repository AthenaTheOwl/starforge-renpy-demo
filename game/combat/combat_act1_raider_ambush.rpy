## combat_act1_raider_ambush.rpy — Narrative combat: Raider Ambush
## Enemies: 3x Raider Scrapper
## Auto-generated skeleton — add flavor text

label combat_act1_raider_ambush:
    $ _nc = NarrativeCombat("act1_raider_ambush")
    show screen combat_hud(_nc)

    "Fast-moving scrappers burst from cover. Quick and aggressive, testing your ability to handle multiple fast threats."
...
label .combat_end:
    ...
    if _nc.victory:
        $ game_state.mark_encounter_cleared("act1_raider_ambush")
        $ party_manager.award_xp(150)
        $ game_state.set_flag("raider_ambush_survived")
        ...
        $ game_state.set_flag("act1_raider_ambush_lost")
