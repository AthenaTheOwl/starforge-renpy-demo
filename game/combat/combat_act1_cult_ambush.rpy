## combat_act1_cult_ambush.rpy — Narrative combat: Cult Hierophant Ambush
## Enemies: 1x Cult Hierophant, 3x Cult Acolyte
## Auto-generated skeleton — add flavor text

label combat_act1_cult_ambush:
    $ _nc = NarrativeCombat("act1_cult_ambush")
    show screen combat_hud(_nc)

    "A cult hierophant commands three acolytes. Mass ward buffs, resonance storms, and healing make this a war of attrition. Focus fire or be overwhelmed."
...
label .combat_end:
    ...
    if _nc.victory:
        $ game_state.mark_encounter_cleared("act1_cult_ambush")
        $ party_manager.award_xp(200)
        $ game_state.set_flag("hierophant_defeated")
        ...
        $ game_state.set_flag("act1_cult_ambush_lost")
